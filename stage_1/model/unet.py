...
def UNet(input_shape=(512,512,1), k_size=3):
    ...
    merged1 = concatenate([conv4, conv6], axis=-1)
    ...
    merged2 = concatenate([conv3, conv7], axis=-1)
    ...
    merged3 = concatenate([conv2, conv8], axis=-1)
    ...
    merged4 = concatenate([conv1, conv9], axis=-1)
